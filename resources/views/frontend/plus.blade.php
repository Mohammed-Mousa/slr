...
<section class="header">
		...
		<div id="carouselExample" data-bs-ride="carousel" class="carousel slide carousel-dark carousel-fade">
			<div class="carousel-inner">
				<div class="carousel-item item active" data-bs-interval="5000">
					...
					<img src="{{URL::asset('assets/frontend/img/main/sec1.jpg')}}" class="d-block w-100">
				</div>
				<div class="carousel-item item" data-bs-interval="2500">
					<img src="{{URL::asset('assets/frontend/img/main/sec2.jpg')}}" class="d-block w-100">
				</div>
			</div>
	...
	{{-- <div data-aos="zoom-in" class="container-lg px-0 wow fadeIn">
		<div class="owl-carousel owl-theme" id="header-carousel">
			<figure class="item">
				<img src="{{URL::asset('assets/frontend/img/main/sec1.jpg')}}" alt="">
			</figure>
			<figure class="item">
				<img src="{{URL::asset('assets/frontend/img/main/sec2.jpg')}}" alt="">
			</figure>
		</div>
	</div> --}}
</section>

<section class="products mb-2 mb-lg-3">
	<div class="container">
...
<section class="order  mb-3 mb-lg-4">
	<div data-aos="zoom-in" class="container-lg px-0  wow fadeIn">
		<figure class="item">
			<img src="{{URL::asset('assets/frontend/img/main/order-between_11zon.jpg')}}" alt="">
		</figure>
	</div>
</section>
